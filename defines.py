...
DBG_EXCEPTION_NOT_HANDLED      = 0xC0000008
...
class PRTL_USER_PROCESS_PARAMETERS(Structure):
    _fields_ = [
        ("Reserved1", BYTE),
        ("Reserved2", PVOID),
...
# PROCESS_BASIC_INFORMATION contains information about the PEB structure
